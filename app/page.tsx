    ...
    <div className="min-h-screen bg-gray-50 p-6 pb-20">
      <header className="flex justify-between items-center mb-10 max-w-5xl mx-auto">
        ...
        <div className="flex gap-2 flex-wrap justify-end">
          <a href="/mensajes" className="bg-white border p-2 rounded-lg shadow-sm hover:bg-gray-50 transition">
            💬
          </a>
          <a href="/pisos" className="bg-white border px-3 py-2 rounded-lg shadow-sm hover:bg-gray-50 transition text-sm font-bold text-gray-700">
            🏠 Pisos
          </a>
          ...
          <a href="/perfil" className="bg-indigo-600 text-white px-4 py-2 rounded-lg font-bold hover:bg-indigo-700 transition">
            Mi Perfil
          </a>
        </div>
      </header>
              ...
              return (
                <div key={perfil.id} className="bg-white rounded-3xl shadow-sm border overflow-hidden flex flex-col">
                  <div className="h-64 w-full relative">
                    <img
                      src={perfil.avatar_url || 'https://via.placeholder.com/400?text=Roomie'}
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <p className="text-gray-600 text-sm mb-6 line-clamp-3">"{perfil.biografia}"</p>
                      ...
                      href={`/chat/${perfil.id}`}
                      className="mt-auto w-full text-center bg-gray-900 text-white py-3 rounded-2xl font-bold hover:bg-indigo-600 transition"
                    >
                      Hablar
                    </a>
                  </div>
